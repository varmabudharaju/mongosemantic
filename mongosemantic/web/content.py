...
CONTENT: dict[str, dict[str, str]] = {
    ...
    "visualize": {
        ...
        "subtitle": "2D PCA projection of sampled embeddings. Points close together mean similar by meaning.",
        "control_collection": "Collection",
        "control_field": "Field",
        "control_refresh": "Refresh",
        "empty_too_few": "Not enough embeddings to visualize. Index at least 3 documents first.",
        "tooltip_point": "{text}",
    },
    "aggregation": {
    ...
    "mcp": {
        ...
        "subtitle": "Connect Claude Desktop, Cursor, or any MCP-compatible AI agent to this database. Eleven tools are exposed; agents discover them automatically.",
        "integrate_intro": "One command writes the mongosemantic entry into Claude Desktop's config:",
        "integrate_cmd": "mongosemantic integrate claude",
        "integrate_follow_up": "Restart Claude Desktop after running. The tools appear in the slash menu of every new chat.",
        "serve_intro": "Or run as a standalone MCP server (for Cursor or any client that uses SSE):",
        "serve_cmd": "mongosemantic serve --transport sse --port 8090",
